...
import com.wuwg.component.net.util.NetWorkUtils;
...
public class RetrofitClient {
    ...
    private static OkHttpClient getClient() {
         ...
         * 本地缓存
         */
        File cacheFile = new File(ComponentLibrary.mContext.getCacheDir(), "cache");
    ...
    protected static Interceptor getInterceptor() {
        return new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                if (!NetWorkUtils.isNetConnected(ComponentLibrary.mContext)) {
